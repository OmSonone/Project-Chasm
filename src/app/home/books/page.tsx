        ...
        <div className='flex lg:flex-row flex-col lg:gap-8 mt-6'>
          ...
          <div className='hidden lg:block top-24 sticky lg:w-1/2 xl:w-2/5'>
            ...
            <div className='bg-card mt-4 p-4 border rounded-lg'>
              <h2 className='mb-2 font-bold text-2xl'>{selectedBook.title}</h2>
              ...
              <p className='text-muted-foreground text-sm'>
                ...
                peaks. In it lived the princess, the pale princess...
              </p>
              <div className='flex justify-between gap-2 mt-4'>
                ...
                <Button
                  ...
                  onClick={() =>
                    router.push(`/home/books/${selectedBook.id.split('-')[0]}`)
                  }
                >
                  View All Volumes
                </Button>
