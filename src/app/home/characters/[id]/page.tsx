          ...
          <div className='md:col-span-2 lg:col-span-3'>
            ...
            >
              ...
              <TabsContent value='profile' className='space-y-6'>
                ...
                <div className='bg-card p-4 border rounded-lg'>
                  <h3 className='mb-2 font-semibold text-lg'>Personality</h3>
                  <p className='text-muted-foreground'>
                      ...
                      stories.map((story) => (
                        <AccordionItem key={story.id} value={story.id}>
                          ...
                          <AccordionContent className='px-4 pb-4'>
                            ...
                            <CharacterStoryPlayer story={story} />
                          </AccordionContent>
                        </AccordionItem>
                      ))
              ...
              <TabsContent value='voice' className='space-y-6'>
                <div className='bg-card p-4 border rounded-lg'>
                  <div className='flex justify-between items-center mb-4'>
                    <h3 className='font-semibold text-lg'>Voice-Over</h3>
                    ...
                    {[
                      ...
                      >
                        ...
                        >
                          ...
                          <span className='sr-only'>Play {category}</span>
                        </Button>
                      </div>
                    ))}
                  </div>
