          ...
          <div className='sticky lg:w-1/2 xl:w-2/5'>
            <div className='bg-card p-6 rounded-xl'>
              <div className='flex items-center gap-4 mb-4'>
                ...
                <div>
                  <h2 className='font-bold text-2xl'>Noctilucous Jade</h2>
              ...
              <div className='space-y-4 mt-4'>
                <div>
                  ...
                  <p className='text-muted-foreground text-sm'>
                    A rare mineral that glows in the dark. It&apos;s said to be
                    a product of the condensation of pure elemental energy.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className='text-muted-foreground text-sm'>
                    Found in Liyue, particularly in Minlin and around Mt. Hulao.
                    Can also be purchased from Shitou in Liyue Harbor.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className='space-y-1 text-muted-foreground text-sm'>
                    <li>• Character Ascension: Beidou, Yanfei</li>
                    <li>• Weapon Ascension: Prototype Archaic</li>
                    <li>• Crafting: Lanterns, Adepti Seeker&apos;s Stove</li>
                  </ul>
                </div>
              </div>
            </div>
